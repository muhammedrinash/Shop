...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center px-6 relative overflow-hidden py-24">
      ...
      <div className="absolute top-1/4 -right-20 w-[500px] h-[500px] bg-premium-violet/10 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-1/4 -left-20 w-[500px] h-[500px] bg-premium-violet/5 blur-[120px] rounded-full pointer-events-none" />

      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-black italic tracking-tighter uppercase mb-2">
            Join <span className="text-premium-violet">Viluxe.</span>
          </h1>
          <p className="text-zinc-400">Create an account to track orders and save favorites.</p>
        </div>

        <form onSubmit={handleRegister} className="bg-zinc-900/40 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="space-y-6">
            <div>
              <label className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em] mb-2 block ml-1">Full Name</label>
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-500 group-focus-within:text-premium-violet transition-colors" size={18} />
                <input 
                  type="text" 
                  value={name}
            ...
            <div>
              <label className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em] mb-2 block ml-1">Password</label>
              <div className="relative group">
          ...
          <p className="text-center text-zinc-500 text-xs font-medium mt-8">
            Already have an account? <Link to="/login" className="text-white font-bold hover:text-premium-violet transition-colors underline underline-offset-4 decoration-white/20 hover:decoration-premium-violet">Sign in</Link>
          </p>
        </form>
